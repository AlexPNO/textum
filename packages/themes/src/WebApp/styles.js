...
export const colors = {
  primary: '#2BD7B8',// '#DAE9EE',//'#2BD7B8',   
  secondary: '#2D5D7C', //2D5D7C   141821
  tertiary: '#33B9E3',
  quaternary: '#DAE9EE',
  error: '#EB5757',
  success: '#27AE60',
  shades: {
    ...
    quaternary: ['#DAE9EE', '#FF6847', '#FB7C61', '#FF9680'],
  },
  ...
  gradients: {
    ...
    quaternary: 'linear-gradient(144.99deg, #DAE9EE 22.12%, #FB7C61 77.88%)',
  },
  svgGradients: {
    primary: {
      from: '#2BD7B8',
